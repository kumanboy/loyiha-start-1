...
/* harmony default export */ __webpack_exports__["default"] = (clas);
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_server_server__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/qulpinisa', json).then(data => {
        console.log(data);
